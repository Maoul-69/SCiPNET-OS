...
declare -A APP_ICONS=(
    ["terminal"]="scp-logo"
    ["fichiers"]="dossier-logo"
    ["base-scp"]="Base-SCP-logo"
    ["personnel"]="personnel-logo"
    ["chiffrement"]="chiffrement-logo"
    ["site-map"]="Site-Map-logo"
    ["messagerie"]="messagerie-logo"
    ["armement"]="armement-logo"
    ["parametres"]="paramètres-logo"
)
